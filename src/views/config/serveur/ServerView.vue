...
import { ref } from "vue";
import { columnsServer } from '@/utils/kendo/col';
    ...
    >
      <template v-slot:activator="{ props }">
        <v-btn color="secondary" dark v-bind="props" rounded="outlined" class="ml-auto mt-5">
            <v-icon class="mr-2">mdi-account-multiple-plus</v-icon>Ajouter un serveur
        </v-btn>
      </template>
      <v-card class="p-10">
        <v-toolbar dark style="flex: unset">
          ...
          <v-toolbar-title class="text-white">Append Serveur</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
        ...
        <v-card-item class="px-4">
            <Form @submit=""  class="">
                <v-row>
                    <v-col cols="12" sm="4">
                        <v-label class="text-subtitle-1 font-weight-medium pb-2">IP Address/IPV4*</v-label>
                        <VTextField
                            class="mb-4"
                            required
                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="4">
                        <v-label class="text-subtitle-1 font-weight-medium pb-2">Route API*</v-label>
                        <VTextField
                        class="mb-4"
                        required
                        hide-details="auto"></VTextField>  
                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="4">
                        <v-label class="text-subtitle-1 font-weight-medium pb-2">Language*</v-label>
                        <VTextField
                        class="mb-4"
                        required
                        hide-details="auto"></VTextField>
